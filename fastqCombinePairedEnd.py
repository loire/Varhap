...
Usage:
    python fastqCombinePairedEnd.py input1 input2  outputdir separator
...
if __name__ == "__main__":
    ...
    with myopen(outdir+"/"+bin1 + "_pairs_R1" + outSuffix, "w") as out1:
        with myopen(outdir+"/"+bin2 + "_pairs_R2" + outSuffix, "w") as out2:
            with myopen(outdir+"/"+bin1 + "_widows" + outSuffix, "w") as out3:
